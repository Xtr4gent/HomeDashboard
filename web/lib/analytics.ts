...
function buildSnapshotPayload(dashboard: Awaited<ReturnType<typeof getDashboardData>>, sourceEventKey: string) {
  ...
  return {
    ...
    utilityProjectionPlannedCents: dashboard.utilityProjection.plannedCents,
    utilityProjectionActualCents: dashboard.utilityProjection.actualCents,
    utilityProjectionVarianceCents: dashboard.utilityProjection.varianceCents,
    utilityProjectionCoverageCount: dashboard.utilityProjection.coverageCount,
    upgradeProjectionPlannedCents: dashboard.upgradeProjection.plannedCents,
    upgradeProjectionActualCents: dashboard.upgradeProjection.actualCents,
    upgradeProjectionVarianceCents: dashboard.upgradeProjection.varianceCents,
    upgradeProjectionCoverageCount: dashboard.upgradeProjection.coverageCount,
